        ...
        function graficoVentas(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'MediaMarktSaturno' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_MediaMarkt")
        ...
        function graficoVentasUnaSemana(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'MediaMarktSaturno' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_MediaMarkt")
        ...
        function graficoVentasUnMes(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'MediaMarktSaturno' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_MediaMarkt")
