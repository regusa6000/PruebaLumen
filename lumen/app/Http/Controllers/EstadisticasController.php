        ...
        function graficoVentas(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Waadby Payment' OR hg_orders.payment = 'amazon_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),2) AS Sum_Amazon")
                                ,DB::raw("ROUND((100* (SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Waadby Payment' OR hg_orders.payment = 'amazon_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0)/SUM(o.total_paid)),2) AS 'porcentajeAmazon'")
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Manomano' OR hg_orders.payment = 'manomano_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0),2) AS Sum_Manomano")
                                ,DB::raw("ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Manomano' OR hg_orders.payment = 'manomano_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0)/SUM(o.total_paid)),2) AS 'porcentajeManomano'")
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Carrefour' OR hg_orders.payment = 'carrefour_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0),2) AS Sum_Carrefour")
                                ,DB::raw("ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Carrefour' OR hg_orders.payment = 'carrefour_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ) /SUM(o.total_paid)),2) AS 'porcentajeCarrefour'")
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Fnac")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ) /SUM(o.total_paid)),2),0) AS 'porcentajeFnac'")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'MediaMarktSaturno' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_MediaMarkt")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'MediaMarktSaturno' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ) /SUM(o.total_paid)),2),0) AS 'porcentajeMediaMarkt'")
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'Groupon' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Groupon")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'Groupon' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ) /SUM(o.total_paid)),2),0) AS 'porcentajeGroupon'"))
        ...
        function graficoVentasUnaSemana(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Waadby Payment' OR hg_orders.payment = 'amazon_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),2) AS Sum_Amazon")
                                ,DB::raw("ROUND((100* (SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Waadby Payment' OR hg_orders.payment = 'amazon_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7)/SUM(o.total_paid)),2) AS 'porcentajeAmazon'")
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Manomano' OR hg_orders.payment = 'manomano_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7),2) AS Sum_Manomano")
                                ,DB::raw("ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Manomano' OR hg_orders.payment = 'manomano_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7)/SUM(o.total_paid)),2) AS 'porcentajeManomano'")
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Carrefour' OR hg_orders.payment = 'carrefour_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7),2) AS Sum_Carrefour")
                                ,DB::raw("ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Carrefour' OR hg_orders.payment = 'carrefour_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ) /SUM(o.total_paid)),2) AS 'porcentajeCarrefour'")
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Fnac")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ) /SUM(o.total_paid)),2),0) AS 'porcentajeFnac'")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'MediaMarktSaturno' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_MediaMarkt")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'MediaMarktSaturno' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ) /SUM(o.total_paid)),2),0) AS 'porcentajeMediaMarkt'")
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'Groupon' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Groupon")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'Groupon' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ) /SUM(o.total_paid)),2),0) AS 'porcentajeGroupon'"))
        ...
        function graficoVentasUnMes(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Waadby Payment' OR hg_orders.payment = 'amazon_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),2) AS Sum_Amazon")
                                ,DB::raw("ROUND((100* (SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Waadby Payment' OR hg_orders.payment = 'amazon_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30)/SUM(o.total_paid)),2) AS 'porcentajeAmazon'")
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Manomano' OR hg_orders.payment = 'manomano_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30),2) AS Sum_Manomano")
                                ,DB::raw("ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Manomano' OR hg_orders.payment = 'manomano_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30)/SUM(o.total_paid)),2) AS 'porcentajeManomano'")
                                ...
                                ,DB::raw("ROUND((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Carrefour' OR hg_orders.payment = 'carrefour_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30),2) AS Sum_Carrefour")
                                ,DB::raw("ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Carrefour' OR hg_orders.payment = 'carrefour_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ) /SUM(o.total_paid)),2) AS 'porcentajeCarrefour'")
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Fnac")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ) /SUM(o.total_paid)),2),0) AS 'porcentajeFnac'")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'MediaMarktSaturno' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_MediaMarkt")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'MediaMarktSaturno' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ) /SUM(o.total_paid)),2),0) AS 'porcentajeMediaMarkt'")
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'Groupon' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Groupon")
                                ,DB::raw("IFNULL(ROUND((100*(SELECT SUM(hg_orders.total_paid) FROM hg_orders WHERE hg_orders.payment = 'Groupon' AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ) /SUM(o.total_paid)),2),0) AS 'porcentajeGroupon'"))
