<?php
    ...
    class EstadisticasController extends Controller{
        ...
        function carrefour(){
            ...
            $resultado = DB::table('hg_orders')
                        ->select(DB::raw('DAY(hg_orders.date_add) AS dia'),
                                ...
                                DB::raw("(SELECT ROUND(SUM(o.total_paid),2) FROM hg_orders AS o
                                            WHERE  YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add)  AND DAY(o.date_add) = DAY(hg_orders.date_add)  AND
                                            (o.payment = 'Carrefour' OR o.payment = 'carrefour_es') AND o.current_state <> 6 AND o.current_state <> 7) AS IMPORTE"))
                        ->join('hg_ewax_orders  AS eo','eo.id_order','=','hg_orders.id_order')
                        ->where(DB::raw("YEAR (hg_orders.date_add)>2020 and hg_orders.reference NOT LIKE 'INCI-%' AND eo.send_ok = 1 AND week(hg_orders.date_add,7)"),'>',DB::raw('WEEK(NOW(),7)-2'))
                        ->groupBy(DB::raw('day(hg_orders.date_add)'),DB::raw('month(hg_orders.date_add)'),DB::raw('YEAR (hg_orders.date_add)'))
                        ->orderBy(DB::raw('YEAR(hg_orders.date_add)'),'DESC')
        ...
        function amazon(){
            ...
            $resultado = DB::table('hg_orders')
                        ->select(DB::raw('DAY(hg_orders.date_add) AS dia'),
                                ...
                                DB::raw("(SELECT ROUND(SUM(o.total_paid),2) FROM hg_orders AS o
                                            WHERE  YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add)  AND DAY(o.date_add) = DAY(hg_orders.date_add) AND
                                            (o.payment = 'Waadby Payment' OR o.payment = 'amazon_es') AND o.current_state <> 6 AND o.current_state <> 7) AS IMPORTE"))
                        ->join('hg_ewax_orders  AS eo','eo.id_order','=','hg_orders.id_order')
                        ->where(DB::raw("YEAR (hg_orders.date_add)>2020 and hg_orders.reference NOT LIKE 'INCI-%' AND eo.send_ok = 1 AND week(hg_orders.date_add,7)"),'>',DB::raw('WEEK(NOW(),7)-2'))
                        ->groupBy(DB::raw('day(hg_orders.date_add)'),DB::raw('month(hg_orders.date_add)'),DB::raw('YEAR (hg_orders.date_add)'))
                        ->orderBy(DB::raw('YEAR(hg_orders.date_add)'),'DESC')
        ...
        function fnac(){
            $resultado = DB::table('hg_orders')
                        ->select(DB::raw('DAY(hg_orders.date_add) AS dia'),
                                ...
                                DB::raw("(SELECT ROUND(sum(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add)  AND DAY(o.date_add) = DAY(hg_orders.date_add)  AND
                                            (o.payment = 'Fnac MarketPlace' OR o.payment = 'fnac_es') AND o.current_state <> 6 AND o.current_state <> 7) AS IMPORTE"))
                        ->join('hg_ewax_orders  AS eo','eo.id_order','=','hg_orders.id_order')
                        ->where(DB::raw("YEAR (hg_orders.date_add)>2020 and hg_orders.reference NOT LIKE 'INCI-%' AND eo.send_ok = 1 AND week(hg_orders.date_add,7)"),'>',DB::raw('WEEK(NOW(),7)-2'))
                        ->groupBy(DB::raw('day(hg_orders.date_add)'),DB::raw('month(hg_orders.date_add)'),DB::raw('YEAR (hg_orders.date_add)'))
                        ->orderBy(DB::raw('YEAR(hg_orders.date_add)'),'DESC')
        ...
        function sumatorioCarrefour(){
            ...
            $resultado = DB::table('hg_orders')
                        ->select(   DB::raw('week(hg_orders.date_add,7) AS semana'),
                                    ...
                                    DB::raw("(SELECT ROUND(SUM(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND DAY(o.date_add) = DAY(hg_orders.date_add) AND
                                            (o.payment = 'Carrefour' OR o.payment = 'carrefour_es') AND o.current_state <> 6 AND o.current_state <> 7) AS CARREFOUR_SUM"))
                        ->join('hg_ewax_orders AS eo','eo.id_order','=','hg_orders.id_order')
                        ->where(DB::raw('YEAR(hg_orders.date_add)'),'>',DB::raw('2020 AND eo.send_ok = 1 AND week(hg_orders.date_add) > WEEK(NOW())-52'))
                        ->groupBy(DB::raw('WEEK(hg_orders.date_add)'),DB::raw('YEAR(hg_orders.date_add)'))
                        ->orderBy(DB::raw('YEAR(hg_orders.date_add)'),'DESC')
            ...
            $resultado = DB::table('hg_orders')
                        ->select(   DB::raw('week(hg_orders.date_add,7) AS semana'),
                                    ...
                                    DB::raw("(SELECT ROUND(SUM(o.total_paid),2) FROM hg_orders AS o
                                            ...
                                            (o.payment = 'Waadby Payment' OR o.payment = 'amazon_es') AND o.current_state <> 6 AND o.current_state <> 7) AS AMAZON_SUM"))
                        ->join('hg_ewax_orders AS eo','eo.id_order','=','hg_orders.id_order')
                        ->where(DB::raw('YEAR(hg_orders.date_add)'),'>',DB::raw('2020 AND eo.send_ok = 1 AND week(hg_orders.date_add) > WEEK(NOW())-52'))
                        ->groupBy(DB::raw('WEEK(hg_orders.date_add)'),DB::raw('YEAR(hg_orders.date_add)'))
                        ->orderBy(DB::raw('YEAR(hg_orders.date_add)'),'DESC')
        ...
        function sumatorioFnac(){
            ...
            $resultado = DB::table('hg_orders')
                        ->select(   DB::raw('week(hg_orders.date_add,7) AS semana'),
                                    ...
                                    DB::raw("(SELECT ROUND(sum(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND WEEK(hg_orders.date_add) = WEEK(o.date_add) AND
                                            (o.payment = 'Fnac MarketPlace' OR o.payment = 'fnac_es') AND o.current_state <> 6 AND o.current_state <> 7) AS FNAC_SUM"))
                        ->join('hg_ewax_orders AS eo','eo.id_order','=','hg_orders.id_order')
                        ->where(DB::raw('YEAR(hg_orders.date_add)'),'>',DB::raw('2020 AND eo.send_ok = 1 AND week(hg_orders.date_add) > WEEK(NOW())-52'))
                        ->groupBy(DB::raw('WEEK(hg_orders.date_add)'),DB::raw('YEAR(hg_orders.date_add)'))
                        ->orderBy(DB::raw('YEAR(hg_orders.date_add)'),'DESC')
            ...
            switch($tienda){
                case 1:
                    $resultado = DB::table('hg_orders AS o')
                        ...
                        ->where('od.product_id' , '=', DB::raw("$idProducto AND DATE(o.date_add) BETWEEN '$fechaInicio' AND '$fechaFin' AND o.valid = 1 AND
                ...
                case 2:
                    $resultado = DB::table('hg_orders AS o')
                        ...
                        ->join('hg_product_lang AS pl','pl.id_product','=',DB::raw('od.product_id AND pl.id_lang = 1'))
                        ->where('od.product_id' , '=', DB::raw("$idProducto AND DATE(o.date_add) BETWEEN '$fechaInicio' AND '$fechaFin' AND o.valid = 1 AND
                                (o.payment = 'Manomano' OR o.payment = 'manomano_es') AND o.current_state <> 6 AND o.current_state <> 7"))
                        ->get();
                    break;
                case 3:
                    $resultado = DB::table('hg_orders AS o')
                        ...
                        ->join('hg_product_lang AS pl','pl.id_product','=',DB::raw('od.product_id AND pl.id_lang = 1'))
                        ->where('od.product_id' , '=', DB::raw("$idProducto AND DATE(o.date_add) BETWEEN '$fechaInicio' AND '$fechaFin' AND o.valid = 1 AND
                                (o.payment = 'Carrefour' OR o.payment = 'carrefour_es') AND o.current_state <> 6 AND o.current_state <> 7"))
                        ->get();
                    break;
                case 4:
                    $resultado = DB::table('hg_orders AS o')
                ...
                case 5:
                    $resultado = DB::table('hg_orders AS o')
                        ...
                        ->join('hg_product_lang AS pl','pl.id_product','=',DB::raw('od.product_id AND pl.id_lang = 1'))
                        ->where('od.product_id' , '=', DB::raw("$idProducto AND DATE(o.date_add) BETWEEN '$fechaInicio' AND '$fechaFin' AND o.valid = 1 AND
                                (o.payment = 'Waadby Payment' OR o.payment = 'amazon_es') AND o.current_state <> 6 AND o.current_state <> 7"))
                        ->get();
                    break;
                case 6:
                    $resultado = DB::table('hg_orders AS o')
                ...
                case 9:
                    $resultado = DB::table('hg_orders AS o')
                        ...
                        ->join('hg_product_lang AS pl','pl.id_product','=',DB::raw('od.product_id AND pl.id_lang = 1'))
                        ->where('od.product_id' , '=', DB::raw("$idProducto AND DATE(o.date_add) BETWEEN '$fechaInicio' AND '$fechaFin' AND o.valid = 1 AND
                                (o.payment = 'Fnac MarketPlace' OR o.payment = 'fnac_es') AND o.current_state <> 6 AND o.current_state <> 7"))
                        ->get();
                    break;
                case 10:
                    $resultado = DB::table('hg_orders AS o')
            ...
            $resultado = DB::table('hg_orders')
                        ->select(   DB::raw("DAY(hg_orders.date_add) AS dia"),
                                    ...
                                    DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
                                            ...
                                            OR o.payment = 'Bizum' OR o.payment = 'Bizum - Pago online' or o.payment = 'PayPal' OR o.payment = 'Transferencia bancaria') AND o.current_state <> 6
                                    ...
                                    DB::raw("CONCAT((SELECT round(SUM(o.total_paid),2) FROM hg_orders AS o
                                            ...
                                            OR o.payment = 'Transferencia bancaria') AND o.current_state <> 6 AND o.current_state <> 7 and o.valid = 1 AND o.reference NOT LIKE 'INCI-%'),'€') AS ORION91_SUM"),
                                    DB::raw("CONCAT(ROUND(((SELECT round(SUM(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND DAY(o.date_add) = DAY(hg_orders.date_add) AND o.id_customer <> '107584' AND
                                            (o.payment = 'Pago con tarjeta Redsys' OR o.payment = 'Redsys BBVA' or o.payment = 'Paga Fraccionado' OR o.payment = 'Sequra - Pago flexible' OR o.payment = 'Bizum' OR o.payment = 'Bizum - Pago online' or o.payment = 'PayPal' OR o.payment = 'Transferencia bancaria') AND o.current_state <> 6 AND o.current_state <> 7 and o.valid = 1 AND o.reference NOT LIKE 'INCI-%')/
                                            (SELECT COUNT(o.id_order) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND DAY(o.date_add) = DAY(hg_orders.date_add) AND o.id_customer <> '107584' AND
                                            (o.payment = 'Pago con tarjeta Redsys' OR o.payment = 'Redsys BBVA' OR o.payment = 'Paga Fraccionado' OR o.payment = 'Sequra - Pago flexible' OR o.payment = 'Bizum' OR o.payment = 'Bizum - Pago online' or o.payment = 'PayPal' OR o.payment = 'Transferencia bancaria') AND o.current_state <> 6 AND o.current_state <> 7 AND o.valid = 1 AND o.reference NOT LIKE 'INCI-%')),2),'€') AS MEDIAORION91"),
        ...
        function ventasSemanalesTodasLasTiendas(){
            ...
            $resultado = DB::table('hg_orders')
                        ->select(DB::raw('day(hg_orders.date_add) AS dia')
                                ...
                                ,DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND Day(o.date_add) = Day(hg_orders.date_add) AND (o.payment = 'Waadby Payment' OR o.payment = 'amazon_es')) AS AMAZON")
                                ,DB::raw("IFNULL((SELECT ROUND(SUM(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND Day(o.date_add) = Day(hg_orders.date_add) AND (o.payment = 'Waadby Payment' OR o.payment = 'amazon_es')),0) AS AMAZON_SUM")
                                ,DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
                                ...
                                ,DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND Day(o.date_add) = Day(hg_orders.date_add) AND (o.payment = 'Fnac MarketPlace' OR o.payment = 'fnac_es')) AS FNAC")
                                ,DB::raw("IFNULL((SELECT ROUND(sum(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND Day(o.date_add) = Day(hg_orders.date_add) AND (o.payment = 'Fnac MarketPlace' OR o.payment = 'fnac_es')),0) AS FNAC_SUM")
                                ,DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
                                ...
                                ,DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND Day(o.date_add) = Day(hg_orders.date_add) AND (o.payment = 'Carrefour' OR o.payment = 'carrefour_es')) AS CARREFOUR")
                                ,DB::raw("IFNULL((SELECT ROUND(SUM(o.total_paid),2) FROM hg_orders AS o
                                            WHERE YEAR(o.date_add) = YEAR(hg_orders.date_add) AND MONTH(o.date_add) = MONTH(hg_orders.date_add) AND Day(o.date_add) = Day(hg_orders.date_add) AND (o.payment = 'Carrefour' OR o.payment = 'carrefour_es')),0) AS CARREFOUR_SUM")
                                ,DB::raw("(SELECT COUNT(o.id_order) FROM hg_orders AS o
        ...
        function graficoVentas(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'EMBARGOS' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Embargos")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'MEQUEDOUNO' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_MequedoUno")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Sprinter' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Sprinter")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Bulevip' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Bulevip")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Venca' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Venca")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Fnac")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE (hg_orders.payment = 'MediaMarktSaturno' OR hg_orders.payment = 'Pagado por Marketplace :MediaMarktSaturno') AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_MediaMarkt")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'PcComponentes' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_PcComponentes")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'WISH' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Wish")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'VIPALIA' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Vipalia")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Groupon' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) = 0 ),0),2) AS Sum_Groupon"))
        ...
        function graficoVentasUnaSemana(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'EMBARGOS' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Embargos")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'MEQUEDOUNO' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_MequedoUno")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Sprinter' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Sprinter")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Bulevip' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Bulevip")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Venca' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Venca")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Fnac")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE (hg_orders.payment = 'MediaMarktSaturno' OR hg_orders.payment = 'Pagado por Marketplace :MediaMarktSaturno') AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_MediaMarkt")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'PcComponentes' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_PcComponentes")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'WISH' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Wish")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'VIPALIA' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Vipalia")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Groupon' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 7 ),0),2) AS Sum_Groupon"))
        ...
        function graficoVentasUnMes(){
            ...
            $resultado = DB::table('hg_orders AS o')
                        ->select(DB::raw('ROUND(SUM(o.total_paid),2) AS totalhoy')
                                ...
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'EMBARGOS' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Embargos")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'MEQUEDOUNO' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_MequedoUno")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Sprinter' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Sprinter")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Bulevip' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Bulevip")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Venca' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Venca")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE (hg_orders.payment = 'Fnac MarketPlace' OR hg_orders.payment = 'fnac_es') AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Fnac")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE (hg_orders.payment = 'MediaMarktSaturno' OR hg_orders.payment = 'Pagado por Marketplace :MediaMarktSaturno') AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_MediaMarkt")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'PcComponentes' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_PcComponentes")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'WISH' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Wish")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'VIPALIA' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Vipalia")
                                ,DB::raw("ROUND(IFNULL((SELECT SUM(hg_orders.total_paid) FROM hg_orders INNER JOIN hg_ewax_orders ON hg_ewax_orders.id_order = hg_orders.id_order WHERE hg_orders.payment = 'Groupon' AND hg_ewax_orders.send_ok = 1 AND TIMESTAMPDIFF(DAY, date(hg_orders.date_add), date(NOW())) <= 30 ),0),2) AS Sum_Groupon"))
        ...
        /**DASHBORAD CON FACTURAS DATOS FACTURACIÓN AX**/
        function datosFacturacionAx(){
